      ...
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className={`lg:col-span-5 fade-up ${inView ? "in-view" : ""}`}>
            ...
            <div className="mt-10 space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-medium text-basalt">Apia, Samoa</div>
          ...
          <div className="lg:col-span-7">
            {status === "success" ? (
              <div className="h-full flex flex-col items-center justify-center text-center glass border border-gold/30 rounded-sm p-12">
              ...
              <form onSubmit={submit} className="glass border border-basalt/10 rounded-sm p-6 md:p-10 space-y-6">
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-7 py-4 bg-basalt text-clarity rounded-sm hover:bg-gold hover:text-basalt transition-colors font-medium disabled:opacity-60"
                >
